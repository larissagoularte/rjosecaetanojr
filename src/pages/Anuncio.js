    ...
    <div className="CONTENT w-full flex flex-col md:flex-row bg-neutral-200 text-gray-900">
        ...
        <div className="INFOS md:my-5 my-2 p-10 mx-2 md:mr-2 flex flex-col items-start rounded h-full bg-neutral-100">
          <div className="TITULO-LOCALIZACAO flex justify-between gap-2 mb-2 w-full">
            ...
            <div className="flex flex-col gap-1">
            <div>
              <h1 className="TITULO text-xl text-gray-900">T1 - Rua José Caetano Junior</h1>
              <h1 className="TITULO text-xl text-gray-900">(Ref. SS1Frt)</h1>
             
            </div>
            <div className="mt-1 mb-2">
              <a href='https://maps.app.goo.gl/kir1iv5AZGYvXZoq8'target='_blank' rel="noreferrer" className="text-red-600 underline flex gap-1">
                <FaLocationDot />
                <div className="LOCALIZACAO-LINK text-sm">Rua José Caetano Junior, Covilhã</div>
              </a>
            </div>
            </div>

            <div>
            <h2 className="VALOR-RENDA font-bold text-2xl mb-2 text-gray-900">425€</h2>
            </div>
          </div>
          ...
          <div className="DESCRICAO flex flex-col items-start mb-3">
            ...
            <p className="text-gray-900 font-normal text-wrap">
              A 400 metros do polo IV, a 800 metros da Câmara Municipal.
              <br />
          ...
          <div className="CARACTERISTICAS w-full mb-5 border-t pt-2">
              ...
              <div className="grid md:grid-cols-[3fr_1fr] grid-cols-2">
                ...
                <div className="flex flex-col gap-1 items-end">
                  ...
                  <div className="font-bold text-gray-900 mb-1">Imediato</div>
                </div>
              </div>
